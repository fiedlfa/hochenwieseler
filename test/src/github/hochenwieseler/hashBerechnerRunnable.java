...
/**
 * Eine Runnable um alle Kerne der CPU via Threads möglich zu machen
 * 
 */
public class hashBerechnerRunnable implements Runnable {
	...
	/**
	 * der eigentliche Rechner. laenge ist die restliche laenge des Späteren
	 * Strings (beginnend mit 1) hashValue ist der bishergerechnete Wert für
	...
	private void rechner(int laenge, int hashValue, String value) {
		...
		if (laenge > 0) {
			// Integer.Maxvalue - "zzzzzzz".hashCode() = 2031058437 etc.pp. Gerade die n�chsten Zahlen als Optimierung sind extrem wichtig.
			if (laenge <= 6
